    ...
    <div className="bg-white selection:bg-tiktok-pink selection:text-white">
      ...
      <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-slate-50 text-slate-400 rounded-full text-[10px] font-bold uppercase tracking-[0.2em] mb-8 border border-slate-100">
          ...
          >
            <div className="high-contrast-card rounded-[3.5rem] p-10 shadow-[20px_20px_0px_0px_#f8fafc] relative bg-white border-2 border-slate-900">
              ...
              <div className="flex flex-col items-center mb-10">
                <div className="size-40 rounded-full bg-slate-50 mb-6 overflow-hidden border-2 border-slate-900 shadow-2xl relative p-4 flex items-center justify-center transform hover:rotate-6 transition-transform">
                  <img src="/gia.png" alt="GIA" className="w-full" />
                </div>
                <h3 className="font-black italic text-4xl tracking-tighter mb-1 text-slate-900">GIA</h3>
                <p className="text-[10px] font-black text-slate-400 tracking-[0.3em] uppercase">Generative Influencer Analyst</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
          {[
            ...
            <div key={i} className="text-center group">
              ...
              <p className="text-slate-400 text-xs uppercase font-black tracking-widest leading-loose max-w-[200px] mx-auto">{item.desc}</p>
            </div>
          ))}
        </div>
      </section>
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center px-6 bg-white overflow-hidden">
      ...
      <motion.div
        ...
        className="size-56 rounded-full bg-slate-50 flex items-center justify-center mb-16 relative border-2 border-slate-900 shadow-2xl"
      >
        <img src="/gia.png" alt="GIA" className="z-10 w-40" />
      ...
      <div className="text-center relative">
        <h2 className="text-5xl font-black italic tracking-tighter mb-4 text-slate-900">GIA is listening...</h2>
        ...
        <div className="flex flex-col md:flex-row justify-between items-end gap-10 border-b-2 border-slate-900 pb-12">
          ...
          <div className="flex items-center gap-10">
            <div className="bg-slate-50 p-6 rounded-[2.5rem] border-2 border-slate-900 text-center min-w-32 shadow-[8px_8px_0px_0px_#f1f5f9]">
              <div className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1 leading-none">Hook Score</div>
              <div className="text-5xl font-black italic">{report.overallScore / 10}<span className="text-sm font-normal text-slate-400 ml-1">/10</span></div>
            </div>
        ...
        <div className="flex gap-12 mt-12 overflow-x-auto pb-4 scrollbar-hide">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 whitespace-nowrap px-1 pb-4 border-b-4 transition-all font-black uppercase tracking-widest text-xs tracking-[0.2em] ${activeTab === tab.id ? 'border-tiktok-cyan text-tiktok-black' : 'border-transparent text-slate-400 hover:text-slate-600'}`}
            >
              {tab.icon} {tab.label}
            </button>
          ))}
        ...
        {view === 'input' && (
          ...
          >
             <button 
              ...
              className="absolute top-10 left-10 text-slate-400 hover:text-slate-900 transition-colors flex items-center gap-2 font-black uppercase tracking-widest text-[10px]"
            >
              ← Back
            </button>
            ...
            <div className="max-w-2xl w-full text-center">
              ...
              <div className="relative mb-8">
                ...
                <input 
                  ...
                  className="w-full pl-16 pr-8 py-8 rounded-[2.5rem] border-4 border-slate-900 bg-white focus:outline-none transition-all text-2xl font-black placeholder:font-medium placeholder:text-slate-200 shadow-[12px_12px_0px_0px_#f8fafc]"
                />
              </div>
